	...
	while(kee_rec_cntr < ke_rec_info.kee_rec_id )
	{
		...
		switch(ke_event->event_type)
		{
			...
			case KEETYPE__ASLR_RND_SET:
				...
				copy_to_user(tb_kee, ke_event, sizeof(kernel_entropy_event));
				cpy_ret = copy_to_user(&tb_kee_aslr_set[tb_kee_aslr_set_cntr], &rec_ke_aslr_set[tb_kee_aslr_set_cntr], sizeof(kee_aslr_set));
				...
				cpy_ret = memcpy(&tb_kee_aslr_set[tb_kee_aslr_set_cntr], &rec_ke_aslr_set[tb_kee_aslr_set_cntr], sizeof(kee_aslr_set));
				printk(KERN_EMERG ">>>>>> KEETYPE__ASLR_RND_SET memcpy pid:%d - elf_prot:0x%08X - elf_flags:0x%08X - load_addr:0x%016lX - load_bias:0x%016lX - entry_point:0x%016lX - mmap_rnd:0x%016lX - vaddr:0x%016lX\n - start_code:0x%016lX - end_code:0x%016lX - start_data:0x%016lX - end_data:0x%016lX - error:%lu", tb_kee_aslr_set[tb_kee_aslr_set_cntr].pid, tb_kee_aslr_set[tb_kee_aslr_set_cntr].elf_prot, tb_kee_aslr_set[tb_kee_aslr_set_cntr].elf_flags, tb_kee_aslr_set[tb_kee_aslr_set_cntr].load_addr, tb_kee_aslr_set[tb_kee_aslr_set_cntr].load_bias, tb_kee_aslr_set[tb_kee_aslr_set_cntr].entry_point, tb_kee_aslr_set[tb_kee_aslr_set_cntr].mmap_rnd, tb_kee_aslr_set[tb_kee_aslr_set_cntr].vaddr, tb_kee_aslr_set[tb_kee_aslr_set_cntr].start_code, tb_kee_aslr_set[tb_kee_aslr_set_cntr].end_code, tb_kee_aslr_set[tb_kee_aslr_set_cntr].start_data, tb_kee_aslr_set[tb_kee_aslr_set_cntr].end_data, tb_kee_aslr_set[tb_kee_aslr_set_cntr].error);
				tb_kee_aslr_set_cntr ++;
				break;
			case KEETYPE__RANDOM_INT_SECRET_SET:
				copy_to_user(tb_kee, ke_event, sizeof(kernel_entropy_event));
