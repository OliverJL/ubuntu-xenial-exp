...
__SYSCALL_COMMON(326, sys_kernel_entropy_rec_info, sys_kernel_entropy_rec_info)
__SYSCALL_COMMON(327, sys_kernel_entropy_get_recorded, sys_kernel_entropy_get_recorded)
__SYSCALL_COMMON(328, sys_kernel_entropy_start_recording, sys_kernel_entropy_start_recording)
...
__SYSCALL_COMMON(331, sys_kernel_entropy_get_recordedX, sys_kernel_entropy_get_recordedX)
__SYSCALL_COMMON(332, sys_kernel_entropy_get_recorded_by_type, sys_kernel_entropy_get_recorded_by_type)
__SYSCALL_COMMON(333, sys_kernel_entropy_get_recorded_by_typeX, sys_kernel_entropy_get_recorded_by_typeX)
__SYSCALL_COMMON(334, sys_ke_get_recorded__ke_event_heads, sys_ke_get_recorded__ke_event_heads)
__SYSCALL_COMMON(335, sys_ke_get_recorded__add_interrupt_rnd, sys_ke_get_recorded__add_interrupt_rnd)
__SYSCALL_COMMON(336, sys_ke_get_recorded__stack_canary_set, sys_ke_get_recorded__stack_canary_set)
__SYSCALL_COMMON(337, sys_ke_get_recorded__rnd_int_secret_set, sys_ke_get_recorded__rnd_int_secret_set)
__SYSCALL_COMMON(338, sys_ke_get_recorded__kee_get_rnd_int, sys_ke_get_recorded__kee_get_rnd_int)
__SYSCALL_COMMON(339, sys_ke_get_recorded__kee_get_rnd_long, sys_ke_get_recorded__kee_get_rnd_long)
__SYSCALL_COMMON(340, sys_ke_get_recorded__kee_aslr_set, sys_ke_get_recorded__kee_aslr_set)
