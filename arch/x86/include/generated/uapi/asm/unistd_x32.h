...
#define __NR_kernel_entropy_rec_info (__X32_SYSCALL_BIT + 326)
#define __NR_kernel_entropy_get_recorded (__X32_SYSCALL_BIT + 327)
#define __NR_kernel_entropy_start_recording (__X32_SYSCALL_BIT + 328)
...
#define __NR_kernel_entropy_get_recordedX (__X32_SYSCALL_BIT + 331)
#define __NR_kernel_entropy_get_recorded_by_type (__X32_SYSCALL_BIT + 332)
#define __NR_kernel_entropy_get_recorded_by_typeX (__X32_SYSCALL_BIT + 333)
#define __NR_ke_get_recorded__ke_event_heads (__X32_SYSCALL_BIT + 334)
#define __NR_ke_get_recorded__add_interrupt_rnd (__X32_SYSCALL_BIT + 335)
#define __NR_ke_get_recorded__stack_canary_set (__X32_SYSCALL_BIT + 336)
#define __NR_ke_get_recorded__rnd_int_secret_set (__X32_SYSCALL_BIT + 337)
#define __NR_ke_get_recorded__kee_get_rnd_int (__X32_SYSCALL_BIT + 338)
#define __NR_ke_get_recorded__kee_get_rnd_long (__X32_SYSCALL_BIT + 339)
#define __NR_ke_get_recorded__kee_aslr_set (__X32_SYSCALL_BIT + 340)
